...
class TestCommentCreation(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.user = User.objects.create(username='Комментатор')
        cls.client = Client()
    ...
    def test_authorized_can_create_comment(self):
        response = TestCommentCreation.client.post(
            self.url,
            data=self.form_data
        )
...
class TestCommentEditDelete(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.edit_url = reverse('news:edit', args=(cls.news.pk,))
        cls.delete_url = reverse('news:delete', args=(cls.news.pk,))
